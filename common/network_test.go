...
func TestNormalizedEpochDuration(t *testing.T) {
	...
	require.Equal(t, day*28, NormalizedEpochDuration(saturday, 50000))
	require.Equal(t, day*28, NormalizedEpochDuration(saturday, 60000))
	require.Equal(t, day*28, NormalizedEpochDuration(saturday, 75000))
	require.Equal(t, day*28, NormalizedEpochDuration(saturday, 100000))
	require.Equal(t, day*28, NormalizedEpochDuration(saturday, 500000))
	require.Equal(t, day*28, NormalizedEpochDuration(saturday, 1000000))
	require.Equal(t, day*28, NormalizedEpochDuration(saturday, 100000000))

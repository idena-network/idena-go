...
func TestNormalizedEpochDuration(t *testing.T) {
	...
	sunday := time.Date(2019, 12, 29, 0, 0, 0, 0, time.UTC)
	require.Equal(t, day, NormalizedEpochDuration(sunday, 1, enableUpgrade12))
	require.Equal(t, day*2, NormalizedEpochDuration(sunday, 16, enableUpgrade12))
	require.Equal(t, day*3, NormalizedEpochDuration(sunday, 17, enableUpgrade12))
	require.Equal(t, day*3, NormalizedEpochDuration(sunday, 44, enableUpgrade12))
	require.Equal(t, day*4, NormalizedEpochDuration(sunday, 45, enableUpgrade12))
	require.Equal(t, day*4, NormalizedEpochDuration(sunday, 95, enableUpgrade12))
	require.Equal(t, day*5, NormalizedEpochDuration(sunday, 96, enableUpgrade12))
	require.Equal(t, day*5, NormalizedEpochDuration(sunday, 175, enableUpgrade12))
	require.Equal(t, day*6, NormalizedEpochDuration(sunday, 176, enableUpgrade12))
	require.Equal(t, day*6, NormalizedEpochDuration(sunday, 290, enableUpgrade12))
	require.Equal(t, day*13, NormalizedEpochDuration(sunday, 291, enableUpgrade12))
	require.Equal(t, day*13, NormalizedEpochDuration(sunday, 5844, enableUpgrade12))
	require.Equal(t, day*20, NormalizedEpochDuration(sunday, 5845, enableUpgrade12))
	require.Equal(t, day*20, NormalizedEpochDuration(sunday, 16202, enableUpgrade12))
	require.Equal(t, day*27, NormalizedEpochDuration(sunday, 16203, enableUpgrade12))
	require.Equal(t, day*27, NormalizedEpochDuration(sunday, 9999999, enableUpgrade12))

	wednesday := time.Date(2020, 1, 1, 0, 0, 0, 0, time.UTC)
	require.Equal(t, day, NormalizedEpochDuration(wednesday, 1, enableUpgrade12))
	require.Equal(t, day*2, NormalizedEpochDuration(wednesday, 16, enableUpgrade12))
	require.Equal(t, day*3, NormalizedEpochDuration(wednesday, 17, enableUpgrade12))
	require.Equal(t, day*3, NormalizedEpochDuration(wednesday, 44, enableUpgrade12))
	require.Equal(t, day*4, NormalizedEpochDuration(wednesday, 45, enableUpgrade12))
	require.Equal(t, day*4, NormalizedEpochDuration(wednesday, 95, enableUpgrade12))
	require.Equal(t, day*5, NormalizedEpochDuration(wednesday, 96, enableUpgrade12))
	require.Equal(t, day*5, NormalizedEpochDuration(wednesday, 175, enableUpgrade12))
	require.Equal(t, day*6, NormalizedEpochDuration(wednesday, 176, enableUpgrade12))
	require.Equal(t, day*6, NormalizedEpochDuration(wednesday, 290, enableUpgrade12))
	require.Equal(t, day*15, NormalizedEpochDuration(wednesday, 291, enableUpgrade12))
	require.Equal(t, day*15, NormalizedEpochDuration(wednesday, 5844, enableUpgrade12))
	require.Equal(t, day*22, NormalizedEpochDuration(wednesday, 5845, enableUpgrade12))
	require.Equal(t, day*22, NormalizedEpochDuration(wednesday, 16202, enableUpgrade12))
	require.Equal(t, day*29, NormalizedEpochDuration(wednesday, 16203, enableUpgrade12))
	require.Equal(t, day*29, NormalizedEpochDuration(wednesday, 9999999, enableUpgrade12))
}

...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(idenadb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db idenadb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db idenadb.Database, root common.Hash) error {
...
func checkStateConsistency(db idenadb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, idenadb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(idenadb.Database), srcRoot)

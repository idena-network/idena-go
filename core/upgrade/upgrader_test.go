...
func TestUpgrader_CanUpgrade(t *testing.T) {
	...
	appState.IdentityState.SetValidated(common.Address{0x4})
	...
	appState.IdentityState.SetValidated(common.Address{0xa})
	...
	appState.IdentityState.SetValidated(common.Address{0xc})
	appState.IdentityState.SetDelegatee(common.Address{0xc}, common.Address{0xb})

	appState.IdentityState.SetValidated(common.Address{0xd})
	...
	appState.IdentityState.SetValidated(common.Address{0xe})
	appState.IdentityState.SetOnline(common.Address{0xe}, true)

	appState.IdentityState.SetValidated(common.Address{0xf})
	...
	appState.IdentityState.SetValidated(common.Address{0x1, 0x2})
	...
	appState.IdentityState.SetValidated(common.Address{0x1, 0x3})
	...
	appState.IdentityState.SetValidated(common.Address{0x1, 0x7})
	appState.IdentityState.SetDelegatee(common.Address{0x1, 0x7}, common.Address{0x1, 0x6})

	appState.IdentityState.SetValidated(common.Address{0x1, 0x8})
	appState.IdentityState.SetDelegatee(common.Address{0x1, 0x8}, common.Address{0x1, 0x6})

	appState.IdentityState.SetValidated(common.Address{0x1, 0x9})

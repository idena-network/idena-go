...
func newTestLDB() (*idenadb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "idenadb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := idenadb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(idenadb.NewMemDatabase(), t)
}

func testPutGet(db idenadb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(idenadb.NewMemDatabase(), t)
}

func testParallelPutGet(db idenadb.Database, t *testing.T) {
	const n = 8

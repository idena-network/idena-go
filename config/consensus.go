...
type ConsensusConf struct {
	...
	FirstInvitationValidationRewardCoef  float32
	SecondInvitationValidationRewardCoef float32
	ThirdInvitationValidationRewardCoef  float32
...
func GetDefaultConsensusConfig() *ConsensusConf {
	return &ConsensusConf{
		...
		FirstInvitationValidationRewardCoef:  1.0,
		SecondInvitationValidationRewardCoef: 3.0,
		ThirdInvitationValidationRewardCoef:  6.0,
